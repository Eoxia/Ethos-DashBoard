...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	class TGM_Plugin_Activation extends \eoxia\Singleton_Util {
		/**
			...
			if ( ! empty( $message ) || $total_required_action_count > 0 ) {
				...
				if ( ! current_user_can( 'activate_plugins' ) && ! current_user_can( 'install_plugins' ) && ! current_user_can( 'update_plugins' ) ) {
					...
					foreach ( $message as $type => $plugin_group ) {
						...
						$linked_plugins = array_map( array( '\ethos_dashboard\TGMPA_Utils', 'wrap_in_em' ), $linked_plugins );
	...
	if ( ! function_exists( '\ethos_dashboard\load_tgm_plugin_activation' ) ) {
		/**
	...
	if ( did_action( 'plugins_loaded' ) ) {
		...
		add_action( 'plugins_loaded', '\ethos_dashboard\load_tgm_plugin_activation' );
	}
}

if ( ! function_exists( '\ethos_dashboard\tgmpa' ) ) {
	/**
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
				...
				if ( is_wp_error( $activate ) ) {
					...
					$plugin_names = array_map( array( '\ethos_dashboard\TGMPA_Utils', 'wrap_in_strong' ), $plugin_names );
 ...
 * @since 2.2.0
 */
add_action( 'admin_init', '\ethos_dashboard\tgmpa_load_bulk_installer' );
if ( ! function_exists( '\ethos_dashboard\tgmpa_load_bulk_installer' ) ) {
	/**
	 * Load bulk installer
	 */
...
if ( ! class_exists( '\ethos_dashboard\TGMPA_Utils' ) ) {
